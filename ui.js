...
function toggleLoading(isLoading) {
  ...
  const srcbtn = document.getElementById('srchIcon');
  const srchspan = document.getElementById('srchSpan');

  if(isLoading)
  {
    srcbtn.className = 'fas fa-hourglass-half';

    srchspan.textContent = 'Loading...';

    srcbtn.disable = true;
  }
  else
  {
    srcbtn.className = 'fas fa-search';

    srchspan.textContent = 'Search';

    srcbtn.disable = false;
  }
}
